module mod_cut_histo_fb_ATLAS_160601736
  use mod_types
  use mod_consts_dp
  use mod_parms
  use mod_proc_parms
...
contains
  ...
  subroutine init_user_histo()
    ...
    call new_histo('dY_rate',0._dp,1._dp,0.5_dp)       !-- 17
    call new_histo('dY_mll',200._dp,3000._dp,10._dp)   !-- 18
    call new_histo('dY_yll' ,-5._dp,5._dp,0.1_dp)      !-- 19
    call new_histo('dY_ptll',0._dp,3000._dp,10._dp)    !-- 20
    call new_histo('dY_ptlm',10._dp, 3000._dp,10._dp)  !-- 21
    call new_histo('dY_ptlp',10._dp, 3000._dp,10._dp)  !-- 22
    call new_histo('dY_ptl1',10._dp, 3000._dp,10._dp)  !-- 23
    call new_histo('dY_ptl2',10._dp, 3000._dp,10._dp)  !-- 24
    call new_histo('dY_ylm',-5._dp, 5._dp,0.1_dp)      !-- 25
    call new_histo('dY_ylp',-5._dp, 5._dp,0.1_dp)      !-- 26
    call new_histo('dY_dRll',0._dp, 7._dp,0.1_dp)      !-- 27
    call new_histo('dY_dYll',-5._dp, 5._dp,0.1_dp)     !-- 28
    call new_histo('dY_dphill',0._dp,1._dp,0.05_dp)    !-- 29
    call new_histo('dY_costhCS',-one,one,0.05_dp)      !-- 30
    call new_histo('dY_sigmaf',0._dp,1._dp,0.5_dp)     !-- 31
    call new_histo('dY_sigmab',0._dp,1._dp,0.5_dp)     !-- 32
...
end module mod_cut_histo_fb_ATLAS_160601736
