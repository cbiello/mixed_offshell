module mod_cut_histo_cuts_for_kirill
  use mod_types
  use mod_consts_dp
  use mod_parms
  use mod_proc_parms
...
contains
  ...
  subroutine init_user_histo()
    ...
    call new_histo('mllB',200._dp,3000._dp,10._dp)     !-- 35
    call new_histo('mllF',200._dp,3000._dp,10._dp)     !-- 36
  ...
  subroutine cut_histo(event)
    ...
    if ((ptlp .le. ptlp_min) .or. (ptlp .ge. ptlp_max) ) return
...
end module mod_cut_histo_cuts_for_kirill
